...
export default function PricingConfigPage() {
    ...
    const fetchData = async () => {
        ...
        // Fetch suppliers from supplier_addresses table
    ...
    const saveRule = async (supplierId: string, updates: Partial<PricingRule>) => {
        ...
        const existingRule = pricingRules[supplierId]
        ...
        <div className="min-h-screen bg-gray-50 p-8">
            <div className="max-w-6xl mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 mt-2">Configure pricing rules for each supplier (cost vs retail, markup percentages)</p>
                </div>
