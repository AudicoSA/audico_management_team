...
export default function DuplicatesPage() {
    ...
    const fetchData = async () => {
        ...
        try {
            const [skusRes, namesRes, orphanedRes, missingRes] = await Promise.all([
                fetch(`${backendUrl}/api/products/duplicates/skus`),
                fetch(`${backendUrl}/api/products/duplicates/names`),
                fetch(`${backendUrl}/api/products/orphaned`),
                fetch(`${backendUrl}/api/products/missing`)
            ])
