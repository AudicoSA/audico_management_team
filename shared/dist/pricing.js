...
class PricingCalculator {
     ...
     */
    static nologyPricing(costExclVat) {
     ...
     */
    static esquirePricing(costExclVat) {
        const costInclVat = costExclVat * 1.15; // Add 15% VAT
     ...
     */
    static standardMarkup(costPrice, markupPercentage) {
     ...
     * Custom pricing rule
     */
    static customPricing(costPrice, rule) {
     ...
     * Add VAT to a price
     */
    static addVAT(price, vatPercentage = 15) {
        return parseFloat((price * (1 + vatPercentage / 100)).toFixed(2));
    }
    /**
     * Remove VAT from a price
     */
    static removeVAT(priceInclVat, vatPercentage = 15) {
