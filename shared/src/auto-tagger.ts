...
export class ProductAutoTagger {
  /**
  ...
  static shouldExcludeFromConsultation(product: {
    ...
    // Exclude car audio
    if (
      categoryUpper.includes('CAR AUDIO') ||
    ...
    if (
      combined.includes('BLUETOOTH PARTY') ||
