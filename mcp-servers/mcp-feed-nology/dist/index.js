...
class NologyMCPServer {
    ...
    transformToUnified(nologyProduct) {
        var _a;
        // Extract stock info
        const stockInfo = ((_a = nologyProduct.TotalQtyAvailable) === null || _a === void 0 ? void 0 : _a[0]) || {};
    ...
    extractCategory(product) {
        var _a, _b;
        const desc = ((_a = product.ShortDescription) === null || _a === void 0 ? void 0 : _a.toLowerCase()) || '';
        const model = ((_b = product.Model) === null || _b === void 0 ? void 0 : _b.toLowerCase()) || '';
        // Audio categories
