...
class EsquireMCPServer {
        ...
        try {
            ...
            for (let i = 0; i < productsToProcess.length; i++) {
                ...
                try {
                    ...
                    const sku = ((_a = rawProduct.VariantSKU) === null || _a === void 0 ? void 0 : _a[0]) || 'unknown';
    ...
    transformToUnified(esquireProduct) {
        ...
        const sku = ((_a = esquireProduct.VariantSKU) === null || _a === void 0 ? void 0 : _a[0]) || '';
        const productName = ((_b = esquireProduct.Title) === null || _b === void 0 ? void 0 : _b[0]) || '';
        const costPrice = parseFloat(((_c = esquireProduct.VariantPrice) === null || _c === void 0 ? void 0 : _c[0]) || '0');
        const stock = parseInt(((_d = esquireProduct.VariantInventoryQty) === null || _d === void 0 ? void 0 : _d[0]) || '0');
        const imageUrl = ((_e = esquireProduct.ImageSrc) === null || _e === void 0 ? void 0 : _e[0]) || '';
        const description = ((_f = esquireProduct.BodyHTML) === null || _f === void 0 ? void 0 : _f[0]) || '';
        const category = ((_g = esquireProduct.ProductCategory) === null || _g === void 0 ? void 0 : _g[0]) || ((_h = esquireProduct.Handle) === null || _h === void 0 ? void 0 : _h[0]) || '';
        const vendor = ((_j = esquireProduct.Vendor) === null || _j === void 0 ? void 0 : _j[0]) || 'Esquire';
        ...
        return {
            ...
            specifications: {
                sku: sku,
                vendor: vendor,
                tags: ((_k = esquireProduct.Tags) === null || _k === void 0 ? void 0 : _k[0]) || '',
            },
