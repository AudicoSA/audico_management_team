...
import { Stock2ShopMCPServer } from './index';
import { logger } from '@audico/shared';

async function main() {
  logger.info('🧪 Stock2Shop MCP Server - Test Suite');
  logger.info('================================\n');

  const server = new Stock2ShopMCPServer();
  ...
  logger.info('\nNext steps:');
  logger.info('1. Update .env with your Stock2Shop credentials');
