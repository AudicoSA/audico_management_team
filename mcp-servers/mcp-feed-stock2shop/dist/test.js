...
async function main() {
    shared_1.logger.info('🧪 Stock2Shop MCP Server - Test Suite');
    shared_1.logger.info('================================\n');
    const server = new index_1.Stock2ShopMCPServer();
    // Test 1: Connection
    ...
    shared_1.logger.info('\nNext steps:');
    shared_1.logger.info('1. Update .env with your Stock2Shop credentials');
