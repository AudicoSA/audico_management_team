...
class Stock2ShopMCPServer {
    ...
    async syncProducts(options) {
        ...
        try {
            ...
            do {
                ...
                if ((options === null || options === void 0 ? void 0 : options.limit) && allProducts.length >= options.limit) {
    ...
    async searchProducts(query = {}, from = 0, size = 100) {
        ...
        const products = ((_b = (_a = response.data.hits) === null || _a === void 0 ? void 0 : _a.hits) === null || _b === void 0 ? void 0 : _b.map((hit) => hit._source)) || [];
        // Elasticsearch can return total as a number or as an object with value property
        const totalHits = (_c = response.data.hits) === null || _c === void 0 ? void 0 : _c.total;
        const total = typeof totalHits === 'number' ? totalHits : ((totalHits === null || totalHits === void 0 ? void 0 : totalHits.value) || products.length);
    ...
    transformToUnified(s2sProduct) {
        ...
        const variant = (_a = s2sProduct.variants) === null || _a === void 0 ? void 0 : _a[0];
        if (!variant) {
        ...
        // Extract images
        const images = ((_b = s2sProduct.images) === null || _b === void 0 ? void 0 : _b.map(img => img.src)) || [];
    ...
    extractCategory(product) {
        var _a, _b;
        const title = ((_a = product.title) === null || _a === void 0 ? void 0 : _a.toLowerCase()) || '';
        const desc = ((_b = product.body_html) === null || _b === void 0 ? void 0 : _b.toLowerCase()) || '';
