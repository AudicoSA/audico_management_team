    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                <SummaryCard label="Duplicate SKUs" count={duplicateSkus.length} severity="critical" desc="Critical SEO issue" />
                <SummaryCard label="Duplicate Names" count={duplicateNames.length} severity="warning" desc="Needs review" />
                <SummaryCard label="Potential Duplicates" count={potentialDuplicates.length} severity="info" desc="Unaligned vs Aligned" />
                <SummaryCard label="Orphaned Products" count={orphaned.length} severity="error" desc="Not in any feed" />
                <SummaryCard label="Missing Products" count={missing.length} severity="neutral" desc="In feeds, not in store" />
            </div>
