...
import BookShipmentModal from '@/components/dashboard/BookShipmentModal'
...
export default function OrdersPage() {
        ...
        if (isEditing) {
            return (
                <input
                    ...
                    className="w-full px-1 py-0.5 bg-[#2c2c2c] text-white text-xs border border-lime-400 rounded focus:outline-none"
                    autoFocus
                />
            )
        }
    ...
    return (
        <div className="space-y-4 p-6 bg-[#0a0a0a] min-h-full">
                                            ...
                                            <td className="p-2 text-center">
                                                {order.supplier_status !== 'Shipped' && (
                                                    <button
                                                        ...
                                                        title={order.supplier_status === 'Awaiting Payment' ? 'Order not paid' : order.supplier_status === 'Cancelled' ? 'Order cancelled' : 'Book Shipment'}
                                                    >
                                                        ✈
                                                    </button>
                                                )}
