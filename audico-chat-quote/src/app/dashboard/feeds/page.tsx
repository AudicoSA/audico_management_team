...
import { Play, RefreshCw, Server, AlertTriangle, CheckCircle, Clock, Activity } from 'lucide-react'
        ...
        <div className="min-h-screen bg-[#0a0a0a] p-6 text-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-end mb-8">
                    ...
                    <button
                        onClick={checkHealth}
                        className="px-4 py-2 bg-[#1c1c1c] hover:bg-[#2c2c2c] rounded-lg text-sm text-slate-300 transition-colors border border-white/10"
                    >
                        Test Connection
                    </button>
                </div>
                ...
                {view === 'suppliers' && (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="p-6 rounded-2xl border border-orange-500/30 bg-orange-900/10 flex flex-col justify-between hover:scale-[1.02] transition-transform">
                            <div>
                        ...
                        {suppliers.map(sup => (
                            <div key={sup.endpoint} className={`p-6 rounded-2xl border ${sup.enabled ? 'border-white/10' : 'border-red-900/30 opacity-60'} flex flex-col justify-between bg-[#111]`}>
                                <div>
                ...
                {view === 'status' && (
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-[75vh]">
                        <div className="lg:col-span-4 bg-[#111] rounded-2xl p-4 overflow-y-auto border border-white/10 flex flex-col">
                        ...
                        <div className="lg:col-span-8 bg-[#111] rounded-2xl p-6 border border-white/10 overflow-y-auto">
                            {!selectedSession ? (
