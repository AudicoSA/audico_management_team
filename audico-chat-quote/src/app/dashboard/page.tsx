...
import { Mail, Package, TrendingUp, Activity, ArrowUpRight, Plus } from 'lucide-react'
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-[#1c1c1c] border border-white/5 rounded-2xl p-6">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <Link href="/dashboard/products/new" className="p-3 bg-white/5 hover:bg-white/10 rounded-xl flex flex-col items-center justify-center gap-2 transition-colors border border-white/5 text-sm font-medium text-gray-300 hover:text-white hover:border-lime-500/30">
                                <Plus size={20} className="text-lime-400" />
                                New Product
                            </Link>
                            <Link href="/dashboard/stock" className="p-3 bg-white/5 hover:bg-white/10 rounded-xl flex flex-col items-center justify-center gap-2 transition-colors border border-white/5 text-sm font-medium text-gray-300 hover:text-white hover:border-lime-500/30">
