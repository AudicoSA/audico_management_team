...
"use strict";
/**
 * Solution Technologies MCP Server - Test Tool
 */
...
async function main() {
    shared_1.logger.info('🧪 Solution Technologies MCP Server - Test Suite');
    shared_1.logger.info('================================\n');
    const server = new index_1.SolutionTechnologiesMCPServer();
    // Test 1: Connection
    ...
    shared_1.logger.info('\nNext steps:');
    shared_1.logger.info('1. Ensure Solution Technologies supplier exists in Supabase');
    shared_1.logger.info('2. Run: npm run sync -- --limit=10');
    shared_1.logger.info('3. Check Supabase products table');
    shared_1.logger.info('4. Run full sync: npm run sync');
}
main().catch(error => {
